...
export const ROLE_RESOURCES: Record<RoleName, LearningResource[]> = {
  "Data Scientist": [
    ...
    { title: "Data Analysis with Python", description: "FreeCodeCamp hands-on certification", url: "https://www.freecodecamp.org/learn/data-analysis-with-python/", source: "FreeCodeCamp" },
    { title: "Deep Learning Specialization", description: "Andrew Ng's foundational neural networks", url: "https://www.coursera.org/specializations/deep-learning", source: "Coursera" },
    { title: "Pandas Complete Tutorial", description: "Master data manipulation with Pandas", url: "https://www.youtube.com/watch?v=vmEHCJofslg", source: "YouTube" },
    { title: "Data Science with NPTEL", description: "IIT data science fundamentals", url: "https://nptel.ac.in/courses/106/106/106106212/", source: "NPTEL" },
    { title: "Tableau for Data Science", description: "Data visualization and dashboards", url: "https://www.udemy.com/course/tableau10/", source: "Udemy" },
    { title: "Kaggle Machine Learning Intro", description: "Practical ML with real competitions", url: "https://www.youtube.com/watch?v=GwIo3gDZCVQ", source: "YouTube" },
  ],
  "Machine Learning Engineer": [
    ...
    { title: "ML Engineering Full Course", description: "End-to-end ML pipeline development", url: "https://www.youtube.com/watch?v=pCo8vnlzOR4", source: "YouTube" },
    { title: "Feature Engineering for ML", description: "Transform raw data to model features", url: "https://www.udemy.com/course/feature-engineering-for-machine-learning/", source: "Udemy" },
    { title: "Docker for Data Scientists", description: "Containerize ML models", url: "https://www.youtube.com/watch?v=0qG_0CPQhpg", source: "YouTube" },
    { title: "AWS SageMaker Tutorial", description: "Deploy ML models on AWS", url: "https://www.youtube.com/watch?v=8Vj7OaR4DcA", source: "YouTube" },
    { title: "ML System Design", description: "Design production ML systems", url: "https://www.udemy.com/course/machine-learning-system-design/", source: "Udemy" },
  ],
  "AI Engineer": [
    ...
    { title: "OpenAI API Complete Guide", description: "Build applications with GPT APIs", url: "https://www.youtube.com/watch?v=uRQH2CFvedY", source: "YouTube" },
    { title: "RAG Pipeline Tutorial", description: "Retrieval-Augmented Generation systems", url: "https://www.youtube.com/watch?v=sVcwVQRHIc8", source: "YouTube" },
    { title: "Computer Vision with Python", description: "Image processing and object detection", url: "https://www.udemy.com/course/python-for-computer-vision-with-opencv-and-deep-learning/", source: "Udemy" },
    { title: "AI Engineering Specialization", description: "IBM AI Engineering professional cert", url: "https://www.coursera.org/professional-certificates/ai-engineer", source: "Coursera" },
    { title: "Fine-tuning LLMs", description: "Custom model training and adaptation", url: "https://www.youtube.com/watch?v=eC6Hd1hFvos", source: "YouTube" },
  ],
  "Deep Learning Engineer": [
    ...
    { title: "GANs Specialization", description: "Generative Adversarial Networks course", url: "https://www.coursera.org/specializations/generative-adversarial-networks-gans", source: "Coursera" },
    { title: "Neural Networks from Scratch", description: "Build neural networks without frameworks", url: "https://www.youtube.com/watch?v=Wo5dMEP_BbI", source: "YouTube" },
    { title: "Transformer Architecture Deep Dive", description: "Attention mechanism and transformers explained", url: "https://www.youtube.com/watch?v=zxQyTK8quyY", source: "YouTube" },
    { title: "CUDA Programming for DL", description: "GPU-accelerated deep learning", url: "https://www.udemy.com/course/cuda-programming/", source: "Udemy" },
  ],
  "NLP Engineer": [
    ...
    { title: "Text Classification with BERT", description: "Fine-tune BERT for text tasks", url: "https://www.youtube.com/watch?v=IzHCaL-KjdM", source: "YouTube" },
    { title: "Chatbot Development", description: "Build conversational AI systems", url: "https://www.udemy.com/course/complete-chatbot-course/", source: "Udemy" },
    { title: "Named Entity Recognition", description: "NER systems with transformers", url: "https://www.youtube.com/watch?v=G3pOvrKkFuk", source: "YouTube" },
    { title: "NLP with NPTEL", description: "IIT natural language processing", url: "https://nptel.ac.in/courses/106/101/106101007/", source: "NPTEL" },
  ],
  "Data Analyst": [
    ...
    { title: "Advanced SQL Techniques", description: "Window functions, CTEs, and optimization", url: "https://www.youtube.com/watch?v=m1KcNV06_mI", source: "YouTube" },
    { title: "Tableau Complete Course", description: "Master Tableau for data visualization", url: "https://www.udemy.com/course/tableau10/", source: "Udemy" },
    { title: "Python for Data Analysis", description: "Pandas, NumPy, and visualization", url: "https://www.youtube.com/watch?v=r-uOLxNrNk8", source: "YouTube" },
    { title: "Statistics for Data Analysis", description: "Practical statistics essentials", url: "https://www.coursera.org/learn/basic-statistics", source: "Coursera" },
    { title: "Data Storytelling", description: "Communicate insights effectively", url: "https://www.youtube.com/watch?v=9SquYfAn1kM", source: "YouTube" },
  ],
  "Business Analyst": [
    ...
    { title: "Requirements Engineering", description: "Gather and document requirements", url: "https://www.youtube.com/watch?v=0fDrXBSVfnU", source: "YouTube" },
    { title: "Process Mapping with BPMN", description: "Business process modeling notation", url: "https://www.udemy.com/course/bpmn/", source: "Udemy" },
    { title: "Agile Business Analysis", description: "BA in agile environments", url: "https://www.youtube.com/watch?v=z0u_QdRzZkE", source: "YouTube" },
    { title: "Power BI for Business", description: "Create executive dashboards", url: "https://www.coursera.org/learn/power-bi-foundations", source: "Coursera" },
  ],
  "Software Engineer": [
    ...
    { title: "Clean Code Principles", description: "Write maintainable, professional code", url: "https://www.youtube.com/watch?v=7EmboKQH8lM", source: "YouTube" },
    { title: "Design Patterns in Software", description: "SOLID principles and patterns", url: "https://www.udemy.com/course/design-patterns-java/", source: "Udemy" },
    { title: "Git & GitHub Crash Course", description: "Version control mastery", url: "https://www.youtube.com/watch?v=RGOj5yH7evk", source: "YouTube" },
    { title: "Software Engineering with NPTEL", description: "IIT software engineering principles", url: "https://nptel.ac.in/courses/106/105/106105182/", source: "NPTEL" },
    { title: "LeetCode Patterns", description: "Coding interview preparation strategies", url: "https://www.youtube.com/watch?v=DjYZk8nrXVY", source: "YouTube" },
  ],
  "Backend Developer": [
    ...
    { title: "Redis Crash Course", description: "In-memory caching and queues", url: "https://www.youtube.com/watch?v=jgpVdJB2sKQ", source: "YouTube" },
    { title: "Authentication & Authorization", description: "JWT, OAuth, sessions deep dive", url: "https://www.youtube.com/watch?v=2PPSXonhIck", source: "YouTube" },
    { title: "Django REST Framework", description: "Build Python APIs", url: "https://www.udemy.com/course/django-python-advanced/", source: "Udemy" },
    { title: "System Design for Backend", description: "Scalable backend architecture", url: "https://www.youtube.com/watch?v=MbjObHmDbZo", source: "YouTube" },
  ],
  "Frontend Developer": [
    ...
    { title: "JavaScript Mastery Course", description: "Advanced JavaScript concepts", url: "https://www.youtube.com/watch?v=PkZNo7MFNFg", source: "YouTube" },
    { title: "TypeScript Full Course", description: "Type-safe frontend development", url: "https://www.youtube.com/watch?v=30LWjhZzg50", source: "YouTube" },
    { title: "Tailwind CSS Tutorial", description: "Utility-first CSS framework", url: "https://www.youtube.com/watch?v=UBOj6rqRUME", source: "YouTube" },
    { title: "Web Performance Optimization", description: "Core Web Vitals and speed", url: "https://www.udemy.com/course/web-performance/", source: "Udemy" },
    { title: "Accessibility (a11y) Guide", description: "Build inclusive web experiences", url: "https://www.youtube.com/watch?v=e2nkq3h1P68", source: "YouTube" },
  ],
  "Full Stack Developer": [
    ...
    { title: "REST API Design Best Practices", description: "Build professional APIs", url: "https://www.youtube.com/watch?v=fgTGo7Jgcqw", source: "YouTube" },
    { title: "Docker for Full Stack Devs", description: "Containerize your applications", url: "https://www.youtube.com/watch?v=3c-iBn73dDE", source: "YouTube" },
    { title: "Authentication Systems", description: "Build secure auth from scratch", url: "https://www.udemy.com/course/complete-guide-to-building-an-app-with-net-core-and-react/", source: "Udemy" },
    { title: "MongoDB Complete Course", description: "NoSQL database mastery", url: "https://www.youtube.com/watch?v=ExcRbA7fy_A", source: "YouTube" },
  ],
  "React Developer": [
    ...
    { title: "React State Management Deep Dive", description: "Redux, Zustand, React Query patterns", url: "https://www.youtube.com/watch?v=FkUf7rFL8Yw", source: "YouTube" },
    { title: "React Performance Optimization", description: "Memoization and rendering strategies", url: "https://www.youtube.com/watch?v=CaShN-JRcbg", source: "YouTube" },
    { title: "React TypeScript Full Course", description: "Type-safe React development", url: "https://www.youtube.com/watch?v=FJDVKeh7RJI", source: "YouTube" },
    { title: "React Custom Hooks", description: "Build reusable hook patterns", url: "https://www.youtube.com/watch?v=6ThXsUwLWvc", source: "YouTube" },
  ],
  "Django Developer": [
    ...
    { title: "Django Channels & WebSockets", description: "Real-time Django applications", url: "https://www.youtube.com/watch?v=cw8-KFVXpTE", source: "YouTube" },
    { title: "Django Deployment with Docker", description: "Containerize and deploy Django", url: "https://www.udemy.com/course/django-docker/", source: "Udemy" },
    { title: "Django Testing Best Practices", description: "Test-driven Django development", url: "https://www.youtube.com/watch?v=0MrgsYswT1c", source: "YouTube" },
    { title: "Celery Task Queue Tutorial", description: "Async task processing in Django", url: "https://www.youtube.com/watch?v=lnMoMk89FIk", source: "YouTube" },
  ],
  "Python Developer": [
    ...
    { title: "Advanced Python Programming", description: "Decorators, generators, metaclasses", url: "https://www.youtube.com/watch?v=HGOBQPFzWKo", source: "YouTube" },
    { title: "Python Design Patterns", description: "Clean architecture in Python", url: "https://www.udemy.com/course/design-patterns-python/", source: "Udemy" },
    { title: "Python Automation Scripts", description: "Automate boring stuff with Python", url: "https://www.youtube.com/watch?v=s8XjEuplx_U", source: "YouTube" },
    { title: "Python Testing with pytest", description: "Professional testing framework", url: "https://www.youtube.com/watch?v=YbpKMIUjvK8", source: "YouTube" },
  ],
  "Java Developer": [
    ...
    { title: "Spring Microservices", description: "Build microservices with Spring Cloud", url: "https://www.youtube.com/watch?v=BnknNTN8icw", source: "YouTube" },
    { title: "Hibernate & JPA", description: "Object-relational mapping mastery", url: "https://www.udemy.com/course/hibernate-jpa-tutorial-for-beginners-in-100-steps/", source: "Udemy" },
    { title: "Java Multithreading", description: "Concurrent programming deep dive", url: "https://www.youtube.com/watch?v=r_MbozD32eo", source: "YouTube" },
    { title: "Java Design Patterns", description: "Gang of Four patterns in Java", url: "https://www.youtube.com/watch?v=VaXGkwHR868", source: "YouTube" },
  ],
  "DevOps Engineer": [
    ...
    { title: "GitHub Actions CI/CD", description: "Automate workflows with GitHub", url: "https://www.youtube.com/watch?v=R8_veQiYBjI", source: "YouTube" },
    { title: "Linux Administration", description: "Essential Linux for DevOps", url: "https://www.youtube.com/watch?v=sWbUDq4S6Y8", source: "YouTube" },
    { title: "Prometheus & Grafana", description: "Monitoring and observability stack", url: "https://www.youtube.com/watch?v=h4Sl21AKiDg", source: "YouTube" },
    { title: "Ansible Complete Guide", description: "Configuration management automation", url: "https://www.udemy.com/course/learn-ansible/", source: "Udemy" },
    { title: "Jenkins Pipeline Tutorial", description: "Build CI/CD with Jenkins", url: "https://www.youtube.com/watch?v=7KCS70sCoK0", source: "YouTube" },
  ],
  "Cloud Engineer": [
    ...
    { title: "AWS Solutions Architect", description: "Advanced cloud architecture", url: "https://www.udemy.com/course/aws-certified-solutions-architect-associate-saa-c03/", source: "Udemy" },
    { title: "Serverless Architecture", description: "Lambda, Cloud Functions, serverless patterns", url: "https://www.youtube.com/watch?v=W_VV2Fx32_Y", source: "YouTube" },
    { title: "Cloud Networking Deep Dive", description: "VPC, load balancers, DNS mastery", url: "https://www.youtube.com/watch?v=hiKPPy584Mg", source: "YouTube" },
    { title: "Multi-Cloud Strategy", description: "Architecting across cloud providers", url: "https://www.coursera.org/learn/cloud-architecture", source: "Coursera" },
  ],
  "Cybersecurity Analyst": [
    ...
    { title: "SIEM with Splunk", description: "Security information and event management", url: "https://www.youtube.com/watch?v=s-MkhW5kGIQ", source: "YouTube" },
    { title: "Incident Response Fundamentals", description: "Threat detection and mitigation", url: "https://www.udemy.com/course/incident-response/", source: "Udemy" },
    { title: "Vulnerability Assessment", description: "Scanning and risk analysis techniques", url: "https://www.youtube.com/watch?v=BkSISa2GG5k", source: "YouTube" },
    { title: "SOC Analyst Training", description: "Security operations center skills", url: "https://www.youtube.com/watch?v=Bt3pOTKNKns", source: "YouTube" },
  ],
  "Ethical Hacker": [
    ...
    { title: "Web App Hacking", description: "OWASP Top 10 vulnerabilities", url: "https://www.youtube.com/watch?v=2_lswM1S264", source: "YouTube" },
    { title: "Kali Linux Complete Guide", description: "Master the hacker's toolkit", url: "https://www.udemy.com/course/learn-kali-linux/", source: "Udemy" },
    { title: "Burp Suite Tutorial", description: "Web application security testing", url: "https://www.youtube.com/watch?v=h2duGBZLEek", source: "YouTube" },
    { title: "Python for Hackers", description: "Custom exploit development", url: "https://www.youtube.com/watch?v=XWuP2Yf0MHk", source: "YouTube" },
  ],
  "Blockchain Developer": [
    ...
    { title: "DeFi Development", description: "Build decentralized finance protocols", url: "https://www.youtube.com/watch?v=M576WGiDBdQ", source: "YouTube" },
    { title: "Hardhat & Smart Contract Testing", description: "Development and testing frameworks", url: "https://www.youtube.com/watch?v=9Qpi80dQsGU", source: "YouTube" },
    { title: "NFT Marketplace Tutorial", description: "Build an NFT platform", url: "https://www.youtube.com/watch?v=GKJBEEXUha0", source: "YouTube" },
    { title: "Web3.js Complete Guide", description: "Blockchain interaction libraries", url: "https://www.udemy.com/course/web3-blockchain/", source: "Udemy" },
  ],
  "Mobile App Developer": [
    ...
    { title: "Mobile UI/UX Design", description: "Design patterns for mobile", url: "https://www.youtube.com/watch?v=_K3frKHmPeo", source: "YouTube" },
    { title: "App Store Optimization", description: "Publish and market your app", url: "https://www.udemy.com/course/app-store-optimization/", source: "Udemy" },
    { title: "State Management in Flutter", description: "Provider, Riverpod, Bloc patterns", url: "https://www.youtube.com/watch?v=3tm-R7ymwhc", source: "YouTube" },
    { title: "Mobile Backend Integration", description: "REST APIs and Firebase for mobile", url: "https://www.youtube.com/watch?v=fgT6r4f9Apc", source: "YouTube" },
  ],
  "Android Developer": [
    ...
    { title: "MVVM Architecture in Android", description: "Clean architecture patterns", url: "https://www.youtube.com/watch?v=A7CGcFjQQtQ", source: "YouTube" },
    { title: "Room Database Tutorial", description: "Local persistence in Android", url: "https://www.youtube.com/watch?v=lwAvI3WDXBY", source: "YouTube" },
    { title: "Android Networking with Retrofit", description: "API calls and data fetching", url: "https://www.youtube.com/watch?v=JtS8OKXP8lk", source: "YouTube" },
    { title: "Material Design 3", description: "Modern Android UI guidelines", url: "https://www.youtube.com/watch?v=pCd-gAqyCrU", source: "YouTube" },
  ],
  "iOS Developer": [
    ...
    { title: "Core Data & Persistence", description: "Data storage in iOS apps", url: "https://www.youtube.com/watch?v=O7u9nYWjvKk", source: "YouTube" },
    { title: "Swift Concurrency", description: "Async/await and actors in Swift", url: "https://www.youtube.com/watch?v=HqjqwW12wpw", source: "YouTube" },
    { title: "iOS App Store Publishing", description: "Submit and publish your app", url: "https://www.youtube.com/watch?v=H1nRFJxfnCw", source: "YouTube" },
    { title: "Combine Framework Tutorial", description: "Reactive programming in Swift", url: "https://www.youtube.com/watch?v=RysM_XPNMTw", source: "YouTube" },
  ],
  "UI/UX Designer": [
    ...
    { title: "User Research Methods", description: "Interviews, surveys, and testing", url: "https://www.youtube.com/watch?v=0qWoEq8WvHk", source: "YouTube" },
    { title: "Wireframing & Prototyping", description: "From low-fi to high-fi designs", url: "https://www.udemy.com/course/wireframing-and-prototyping/", source: "Udemy" },
    { title: "Accessibility Design Guide", description: "WCAG guidelines for designers", url: "https://www.youtube.com/watch?v=z8xUCzToff8", source: "YouTube" },
    { title: "Design Thinking Process", description: "Human-centered design methodology", url: "https://www.coursera.org/learn/uva-darden-design-thinking-innovation", source: "Coursera" },
  ],
  "Product Manager": [
    ...
    { title: "A/B Testing for PMs", description: "Data-driven product decisions", url: "https://www.youtube.com/watch?v=8H6QmMQWPEI", source: "YouTube" },
    { title: "Roadmapping & Strategy", description: "Build effective product roadmaps", url: "https://www.youtube.com/watch?v=502ILHjX9EE", source: "YouTube" },
    { title: "User Story Writing", description: "Effective requirements documentation", url: "https://www.udemy.com/course/user-stories-in-agile/", source: "Udemy" },
    { title: "Product Analytics", description: "Metrics, KPIs, and funnel analysis", url: "https://www.youtube.com/watch?v=VeZAgfhDpSQ", source: "YouTube" },
  ],
  "QA Engineer": [
    ...
    { title: "Performance Testing with JMeter", description: "Load and stress testing", url: "https://www.youtube.com/watch?v=M-iAXz8vs48", source: "YouTube" },
    { title: "Test Case Design", description: "Boundary analysis and equivalence", url: "https://www.youtube.com/watch?v=GpHYT3O4t6A", source: "YouTube" },
    { title: "Mobile App Testing", description: "Test Android and iOS apps", url: "https://www.udemy.com/course/mobile-app-testing/", source: "Udemy" },
    { title: "CI/CD Testing Integration", description: "Automate tests in pipelines", url: "https://www.youtube.com/watch?v=HKBx2K2yEDg", source: "YouTube" },
  ],
  "Automation Tester": [
    ...
    { title: "BDD with Cucumber", description: "Behavior-driven development testing", url: "https://www.youtube.com/watch?v=gIh-ifzGpMg", source: "YouTube" },
    { title: "API Automation with RestAssured", description: "Java API testing framework", url: "https://www.udemy.com/course/rest-assured/", source: "Udemy" },
    { title: "TestNG Framework", description: "Advanced test execution", url: "https://www.youtube.com/watch?v=KQ-4eiXbjxA", source: "YouTube" },
    { title: "Page Object Model Pattern", description: "Scalable test architecture", url: "https://www.youtube.com/watch?v=MzK-6o5wdSM", source: "YouTube" },
  ],
  "Game Developer": [
    ...
    { title: "Game Physics Programming", description: "Collision detection and physics", url: "https://www.youtube.com/watch?v=lS_qeBy3aQI", source: "YouTube" },
    { title: "C# for Game Development", description: "Programming fundamentals for games", url: "https://www.udemy.com/course/unitycourse/", source: "Udemy" },
    { title: "3D Modeling with Blender", description: "Create game assets from scratch", url: "https://www.youtube.com/watch?v=nIoXOplUvAw", source: "YouTube" },
    { title: "Shader Programming HLSL", description: "Visual effects and shaders", url: "https://www.youtube.com/watch?v=kfM-yu0iQBk", source: "YouTube" },
  ],
  "Embedded Systems Engineer": [
    ...
    { title: "STM32 Microcontroller Guide", description: "ARM Cortex-M development", url: "https://www.youtube.com/watch?v=EExkGJPq96E", source: "YouTube" },
    { title: "PCB Design with KiCad", description: "Design printed circuit boards", url: "https://www.youtube.com/watch?v=vaCVh2SAZY4", source: "YouTube" },
    { title: "Communication Protocols", description: "SPI, I2C, UART deep dive", url: "https://www.youtube.com/watch?v=IyGwvGzrqp8", source: "YouTube" },
    { title: "RTOS Concepts & Design", description: "Real-time operating system internals", url: "https://www.udemy.com/course/mastering-rtos-hands-on-with-freertos-arduino-and-stm32fx/", source: "Udemy" },
    { title: "Oscilloscope & Debugging", description: "Hardware debugging techniques", url: "https://www.youtube.com/watch?v=lqkx45SiqQU", source: "YouTube" },
  ],
  "IoT Engineer": [
    ...
    { title: "MQTT Protocol Tutorial", description: "IoT messaging protocol", url: "https://www.youtube.com/watch?v=EIxdz-2rhLs", source: "YouTube" },
    { title: "Arduino IoT Projects", description: "Build IoT devices with Arduino", url: "https://www.youtube.com/watch?v=09C_Nj7yGnU", source: "YouTube" },
    { title: "Edge Computing Fundamentals", description: "Process data at the edge", url: "https://www.youtube.com/watch?v=cEOUeItHDdo", source: "YouTube" },
    { title: "IoT Security", description: "Secure your IoT devices", url: "https://www.coursera.org/learn/iot-security", source: "Coursera" },
    { title: "Sensor Integration Guide", description: "Temperature, motion, GPS sensors", url: "https://www.youtube.com/watch?v=6F1B_N6LuKw", source: "YouTube" },
  ],
  "Robotics Engineer": [
    ...
    { title: "Computer Vision for Robotics", description: "OpenCV and object detection", url: "https://www.youtube.com/watch?v=oXlwWbU8l2o", source: "YouTube" },
    { title: "PID Control Systems", description: "Control theory for robotics", url: "https://www.youtube.com/watch?v=wkfEZmsQqiA", source: "YouTube" },
    { title: "Gazebo Simulation", description: "Robot simulation environment", url: "https://www.youtube.com/watch?v=9U6GDonGFHw", source: "YouTube" },
    { title: "LIDAR & Sensor Fusion", description: "Autonomous navigation sensors", url: "https://www.udemy.com/course/sensor-fusion/", source: "Udemy" },
  ],
  "AR/VR Developer": [
    ...
    { title: "3D Math for XR", description: "Quaternions, transforms, vectors", url: "https://www.youtube.com/watch?v=d4EgbgTm0Bg", source: "YouTube" },
    { title: "OpenXR Development", description: "Cross-platform XR standard", url: "https://www.youtube.com/watch?v=UF93oGqBBIU", source: "YouTube" },
    { title: "Spatial Audio for VR", description: "3D sound for immersion", url: "https://www.youtube.com/watch?v=8IXm6SuUigI", source: "YouTube" },
    { title: "WebXR Development", description: "AR/VR in the browser", url: "https://www.youtube.com/watch?v=gAzIkjkJSzM", source: "YouTube" },
  ],
};
